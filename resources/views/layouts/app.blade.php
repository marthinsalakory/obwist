...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{Request::routeIs('objek_wisata') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('objek_wisata')}}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; {{ config('app.name') }} {{$current_date_year}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
