    ...
    <form method="POST" class="card shadow mb-4" enctype="multipart/form-data">@csrf
        ...
        <div class="card-body">
            <div class="form-group mb-3">
                ...
                <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{$ow->nama}}">
                @error('nama')
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" value="{{$ow->alamat}}">
                @error('alamat')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="fasilitas" id="fasilitas" class="form-control @error('fasilitas') is-invalid @enderror" value="{{$ow->fasilitas}}">
                @error('fasilitas')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="row mb-3">
                <div class="col-md-6 col-12 form-group">
                    ...
                    <input type="file" name="gambar" id="gambar" class="form-control-file @error('gambar') is-invalid @enderror" value="{{ $ow->gambar}}">
                    @error('gambar')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-md-6 col-12 form-group text-center">
                    <img src="{{url('storage/' . $ow->gambar)}}" id="gambar-preview" src="#" alt="Preview" style="max-width: 200px;">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-6 form-group">
                    <label for="latitude">Latitude</label>
                    <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{$ow->latitude}}">
                    @error('latitude')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-6 form-group">
                    ...
                    <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{$ow->longitude}}">
                    @error('longitude')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
...
<script>
    ...
    marker = L.marker([{{$ow->latitude}}, {{$ow->longitude}}]).addTo(map);
    map.setView([{{$ow->latitude}}, {{$ow->longitude}}], 11);
